...
*/
      ...
      void trim_blanks(); //rm all ' ' and '\t' at beginning and end
      void trim_quotes(); //rm all ' and " at beginning and end
      void trim_quotes_and_blanks(); //rm all ', ", ' ' and '\t' at beginning and end
